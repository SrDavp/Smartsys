...
CREATE TABLE Plataforma (
    ...
    capacidadMiembros_plataforma INT,
    privacidadPlataforma NVARCHAR(50) NOT NULL DEFAULT 'Público',
...
CREATE TABLE usuario_publicaciones(
	...
	fechaCreacion DATETIME2 DEFAULT SYSDATETIME(),
	EntregaTarea VARBINARY(MAX) NULL,
    FechaEntregaUsuario DATETIME NULL,
    EstadoEntrega VARCHAR(20) DEFAULT 'Pendiente',
